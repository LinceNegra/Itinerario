const perguntas = [
...

    {
        ...
        pergunta:
            "Com que frequência você consome frutas, verduras e legumes?",
...

    {
        ...
        pergunta:
            "Com que frequência sua alimentação é baseada em alimentos naturais ou minimamente processados?",
        ...
        alternativas: [
            ...
            {
                texto: "Na maior parte dos dias",
                pontos: 2
            },

            {
                texto: "Todos ou quase todos os dias",
                pontos: 3
            }
...

    {
        ...
        pergunta:
            "Com que frequência você consome alimentos ultraprocessados ou muito industrializados?",

        alternativas: [

            {
                texto: "Várias vezes ao dia",
                pontos: 0
            },
...

    {
        ...
        alternativas: [
            ...
            {
                texto: "1 a 2 dias por semana",
                pontos: 1
            },

            {
                texto: "3 a 4 dias por semana",
                pontos: 2
            },

            {
                texto: "5 dias ou mais por semana",
                pontos: 3
            }
...

    {
        ...
        pergunta:
            "Quando passa muito tempo sentado(a), você costuma fazer pausas para se movimentar?",
...

    {
        ...
        pergunta:
            "No seu dia a dia, você costuma aproveitar oportunidades para caminhar, subir escadas ou se movimentar?",
...

    {
        ...
        pergunta:
            "Em geral, você acorda se sentindo descansado(a)?",
...

    {
        ...
        pergunta:
            "Você costuma dormir e acordar em horários parecidos todos os dias?",
...

    {
        ...
        pergunta:
            "Com que frequência você usa celular, computador ou outros dispositivos próximo do horário de dormir?",
...

    {
        ...
        pergunta:
            "Durante o dia, você costuma beber água regularmente?",
        ...
        alternativas: [
            ...
            {
                texto: "Regularmente ao longo do dia",
                pontos: 3
            }
...

    {
        ...
        pergunta:
            "Você costuma lembrar de beber água antes de sentir muita sede?",
...

    {
        ...
        pergunta:
            "Você costuma manter uma garrafa de água por perto durante o dia?",
    ...
    // =====================================
    // 5 - BEM-ESTAR E ROTINA
    // =====================================

    {
        categoria: "Bem-estar e rotina",

        pergunta:
            "Você reserva momentos da semana para fazer algo que gosta ou que ajuda a relaxar?",
...

    {
        ...
        pergunta:
            "Quando está estressado(a), você costuma fazer algo que ajuda a relaxar?",
...

    {
        ...
        pergunta:
            "Você costuma planejar sua semana de forma a reservar tempo para atividades, descanso e lazer?",
...
const pontosFortesPorCategoria = {
...
function gerarResultado() {
    ...
    if (
        ...
        texto =
            "Seu resultado mostra alguns pontos da sua rotina que podem receber mais atenção. Você não precisa mudar tudo de uma vez: escolha pequenos passos que façam sentido para sua realidade.";
        ...
        texto =
            "Sua rotina apresenta vários hábitos positivos. Existem algumas áreas que podem evoluir gradualmente e fortalecer ainda mais seu cuidado com a saúde e o bem-estar.";
